...
- Where a Photon model download lands on disk, how progress is shown during it, and what the user sees if it fails mid-scan could not be determined from code; the SDK's own output presumably surfaces it.
